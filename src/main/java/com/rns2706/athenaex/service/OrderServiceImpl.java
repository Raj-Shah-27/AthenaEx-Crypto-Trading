...
import com.rns2706.athenaex.repo.OrderItemRepo;
import com.rns2706.athenaex.repo.OrderRepo;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    public OrderServiceImpl(OrderRepo orderRepo, AssetService assetService) {
    ...
    public List<Order> getAllOrdersForUser(Long userId, String orderType, String assetSymbol) {
        List<Order> allUserOrders = orderRepo.findByUserId(userId);
